export const DefaultCard = ({ text1, text2 }) => {
  return (
    <div className="flex-1 min-w-[300px] border-1 border-green-950 bg-(--c60)  shadow-lg rounded-lg p-6 my-5 mx-3 hover:bg-(--c60h) transition-all duration-200 ease-in-out hover:scale-y-105">
